...
@onready var white_sparks = $WhiteSparks
...
func spawn_white_sparks():
	if facing_right:
		white_sparks.position = Vector2(142.0, 28.0)
	else:
		white_sparks.position = Vector2(-146.685, 28.0)
		white_sparks.process_material.direction = Vector3(0.78, -1.0, 0.0)
